...
static const target_map targetList [] = {
    ...
    { "msm7x30", TARGET_MSM7x30 }
};
static targetType mCurrentTarget = TARGET_MSM7x30;
...
// mOverlay(0),
    ...
    if( mCurrentTarget == TARGET_MSM7x30 ) {
...
LOGD("%s mPreviewHeap.clear()", __FUNCTION__);
    mPreviewHeap.clear();
    if(( mCurrentTarget == TARGET_MSM7x30 ) || (mCurrentTarget == TARGET_QSD8250))
        mRecordHeap.clear();
...
bool QualcommCameraHardware::initPreview()
{
   ...
   mPreviewHeap = new PmemPool("/dev/pmem_adsp",
	...
	if(mPostViewHeap == NULL) {
	    ...
	    /* mPostViewHeap should be declared only for 7x30 target */
        ...
        if (width == supportedPreviewSizes[i].width
           && height == supportedPreviewSizes[i].height) {
            ...
            if(width == 1280 && height == 720 &&
             ((mCurrentTarget == TARGET_MSM7x30) || (mCurrentTarget == TARGET_QSD8250))){
